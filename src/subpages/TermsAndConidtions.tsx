			...
			<section className='terms-and-conditions'>
				<div className='terms-and-conditions__container'>
					...
					<div className='terms-and-conditions__box'>
						...
						<p>
							Twoje dane osobowe będą przechowywane przez okres niezbędny do realizacji celów, w jakich zostały zebrane,
							w tym przez okres obowiązywania umowy o świadczenie usług edukacyjnych lub do momentu wycofania zgody na
					...
					<div className='terms-and-conditions__box'>
						...
						<ul>
							...
							<li>
								Problemy techniczne, które mogą wystąpić na stronie internetowej lub w systemie nauczania online, które
					...
					<div className='terms-and-conditions__box'>
						<h2>19. Kontakt</h2>
						<p>
							W razie pytań lub wątpliwości dotyczących Warunków Użytkowania lub Polityki Prywatności, prosimy o kontakt
