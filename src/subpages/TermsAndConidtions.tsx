			...
			<div className='terms-and-conditions__container'>
				...
				<div className='terms-and-conditions__box'>
					...
					<p>
						...
						internetowej], w tym formularze kontaktowe, system nauczania online oraz inne usługi oferowane przez Firmę.
						Prosimy o dokładne zapoznanie się z poniższymi zasadami, ponieważ korzystanie z naszej strony internetowej
						oraz usług wiąże się z akceptacją Polityki Prywatności oraz Warunków Użytkowania.
					</p>
				</div>
				<div className='terms-and-conditions__box'>
				...
				<div className='terms-and-conditions__box'>
					...
					<ul>
						<li>
							Formularz kontaktowy – Użytkownik podaje swoje imię oraz adres e-mail w celu skontaktowania się z Firmą
						</li>
						<li>
							Tłumaczenia – W celu skontaktowania się z nami przez formularz tłumaczenia, użytkownik podaje swoje imię,
				...
				<div className='terms-and-conditions__box'>
					...
					<ul>
						<li>Art. 6 ust. 1 lit. a RODO – zgoda osoby, której dane dotyczą (np. zgoda na kontakt w formularzach)</li>
						<li>
							Art. 6 ust. 1 lit. b RODO – przetwarzanie niezbędne do wykonania umowy (np. rejestracja i dostęp do
							systemu nauczania online)
						</li>
						<li>
							Art. 6 ust. 1 lit. f RODO – uzasadniony interes administratora danych, jakim jest zapewnienie prawidłowego
							funkcjonowania strony internetowej oraz systemu nauczania online
						</li>
				...
				<div className='terms-and-conditions__box'>
					...
					<p>
						Twoje dane osobowe będą przechowywane przez okres niezbędny do realizacji celów, w jakich zostały zebrane, w
						tym przez okres obowiązywania umowy o świadczenie usług edukacyjnych lub do momentu wycofania zgody na
						przetwarzanie danych, jeśli taką zgodę wyraziłeś/aś.
					</p>
				</div>
				<div className='terms-and-conditions__box'>
				...
				<div className='terms-and-conditions__box'>
					...
					<p>
						Na naszej stronie internetowej korzystamy z usługi Google reCAPTCHA, której celem jest ochrona formularzy
						przed automatycznym wypełnianiem przez boty. Google reCAPTCHA zbiera dane dotyczące urządzenia użytkownika,
						takie jak adres IP, dane o przeglądarce, a także inne dane techniczne niezbędne do weryfikacji.
						Przetwarzanie tych danych odbywa się zgodnie z polityką prywatności Google, dostępną pod adresem: [link do
				...
				<div className='terms-and-conditions__box'>
					...
					<p>
						Dokładamy wszelkich starań, aby chronić Twoje dane osobowe przed dostępem osób nieupoważnionych, ich utratą,
						zniszczeniem lub uszkodzeniem. Stosujemy odpowiednie środki techniczne i organizacyjne w celu zapewnienia
				...
				<div className='terms-and-conditions__box'>
					...
					<p>
						...
						nazwisko, adres e-mail oraz numer telefonu). Rejestracja jest dobrowolna, ale niezbędna do pełnego dostępu
						do naszych usług.
					</p>
				</div>
				<div className='terms-and-conditions__box'>
					...
					<ul>
						...
						<li>
							Nieprzesyłania treści niezgodnych z prawem, obraźliwych, wulgarnych lub naruszających prawa osób trzecich
						</li>
					</ul>
				</div>
				<div className='terms-and-conditions__box'>
					<h2>15. Płatności</h2>
					<p>
						W przypadku płatnych usług, użytkownik zobowiązuje się do uiszczenia stosownej opłaty zgodnie z cennikiem
						dostępnym na stronie internetowej. Płatności mogą być realizowane za pośrednictwem dostępnych metod
						płatności.
					</p>
				</div>
				<div className='terms-and-conditions__box'>
					...
					<ul>
						...
						<li>
							Problemy techniczne, które mogą wystąpić na stronie internetowej lub w systemie nauczania online, które są
							poza naszą kontrolą
						</li>
				...
				<div className='terms-and-conditions__box'>
					...
					<p>
						Wszystkie materiały, treści oraz prawa do systemu nauczania online i strony internetowej są własnością Firmy
						lub jej licencjodawców i są chronione prawem autorskim. Użytkownik nie może kopiować, rozpowszechniać ani w
						żaden sposób wykorzystywać materiałów dostępnych na stronie bez uprzedniej zgody Firmy.
					</p>
				</div>
				<div className='terms-and-conditions__box'>
				...
				<div className='terms-and-conditions__box'>
					<h2>19. Kontakt</h2>
					<p>
						W razie pytań lub wątpliwości dotyczących Warunków Użytkowania lub Polityki Prywatności, prosimy o kontakt z
