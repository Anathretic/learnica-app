	...
	return (
		<section className='translations__banner'>
			...
			<div className='polish-classes__special-banner-container'>
				<p>
					*Tłumaczenie zwykłe - <span>strona a4 tj. 1500 znaków ze spacjami.</span> Liczone są znaki widoczne i odstępy
					między wyrazami.
				</p>
				<p>
					Czas oczekiwania na tłumaczenie wynosi <span>4 dni.</span>
				</p>
				<p>
				...
				<p>
					Płatność może być wykonana osobiście w trakcie przekazania dokumentów lub za pomocą przelewu na konto, którego
					numer wysyłamy w wiadomości zwrotnej po wstępnej wycenie.
				</p>
			</div>
