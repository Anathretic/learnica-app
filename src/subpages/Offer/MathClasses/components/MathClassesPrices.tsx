...
const MathClassesPrices: React.FC = () => {
	return (
		<section className='math-classes__prices'>
			<h2 className='math-classes__title math-classes__title--special'>Cennik</h2>
			<div className='math-classes__prices-container'>
				<div className='math-classes__prices-container-box'>
					<h3>Regulaminowa lekcja trwająca 50 minut</h3>
					<p>65 zł</p>
				</div>
				<p className='math-classes__special-paragraph'>-- Last minute --</p>
				<div className='math-classes__prices-container-box'>
					<h3>Pomoc z pracą domową</h3>
					<p>30+ zł</p>
				</div>
				<div className='math-classes__prices-container-box'>
					<h3>Pomoc z zestawem zadań</h3>
					<p>40+ zł</p>
				</div>
				<div className='math-classes__prices-container-box'>
				...
				<p className='math-classes__special-paragraph'>-- Krótki opis --</p>
				<div className='math-classes__prices-container-box math-classes__prices-container-box--info-box'>
			...
			<div className='math-classes__prices-special-block math-classes__prices-special-block--left' />
			<div className='math-classes__prices-special-block math-classes__prices-special-block--right' />
		</section>
	);
};
